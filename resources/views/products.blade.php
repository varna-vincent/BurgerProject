        ...
        <div class="col-sm-6 my-3">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @if($product->type == 'Veg')
                    <button class="align-self-end btn btn-outline-success btn-sm mb-1"><i class="fa fa-leaf"></i></button>
                    @endif</h4>
                    <p class="card-text">{{ $product->description }}</p>
                    <h6 class="card-subtitle mb-2 text-muted"><blockquote class="blockquote price">${{ $product->price }}</blockquote>
                      <button class="btn btn-outline-primary btn-sm mb-1"><i class="fa fa-cart-plus"></i> Add to Cart</button>
                    </h6>
                </div>
            </div>
        </div>
